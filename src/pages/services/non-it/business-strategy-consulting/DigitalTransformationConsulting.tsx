...
const content: any = {
  ...
  technologies: [
    ...
    },
    {
      ...
      desc:
        "We apply automation and intelligent technologies to streamline business processes and improve efficiency.",
      items: [
        "Workflow Automation",
        "AI Enablement",
        "RPA Planning",
    ...
    },
    {
      ...
      desc:
        "We improve data flow and system connectivity across enterprise applications and digital ecosystems.",
      items: [
        "ERP Integration",
        "API Strategy",
        "System Connectivity",
    ...
    {
      icon: "analytics",
      title: "Data, Reporting & Decision Intelligence",
      desc:
        "We build reporting systems and analytics workflows that support better visibility and transformation decision-making.",
      items: [
        "Power BI",
        "Tableau",
  ...
  beforePoints: [
    ...
    "Slow innovation and inefficient decision-making",
  ],
  afterPoints: [
  ...
  contactSubtitle:
    "Ready to modernize your business? Talk to our digital transformation consultants about building a stronger and more scalable future.",

  messageLabel: "Tell us about your transformation goals...",
  submitLabel: "Submit Inquiry",
};

const NonItBusinessStrategyConsultingDigitalTransformationConsulting: React.FC = () => {
...
export default NonItBusinessStrategyConsultingDigitalTransformationConsulting;
