          ...
          <div className="rounded-[32px] bg-white/5 border border-white/10 p-8 md:p-10">
            ...
            <div className="mt-8 hidden xl:block">
              <div className="mx-auto max-w-[1280px] rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,24,43,0.98),rgba(9,14,24,0.99))] p-7 text-white shadow-[0_20px_70px_rgba(15,23,42,0.4)]">
                ...
                <div className="mt-5 rounded-[26px] border border-white/10 bg-[#0f1829] px-3 py-3 shadow-[0_6px_18px_rgba(59,130,246,0.14)] md:px-6 md:py-4">
                  <div className="flex items-center justify-between gap-2 md:gap-4">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 md:gap-4">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[16px] bg-blue-500/10 text-[11px] font-bold text-blue-200 md:h-14 md:w-14 md:text-base">
                          01
                        </div>
                        <div className="min-w-0">
                          <div className="text-[11px] font-medium leading-tight text-white break-normal md:text-[17px]">
                    ...
                    <div className="shrink-0 text-[18px] leading-none text-blue-300 md:text-3xl">
                      →
                    </div>
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 md:gap-4">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-[9px] leading-tight text-blue-200/75 break-normal md:text-[15px]">
                            server / cloud
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 md:gap-4">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[16px] bg-purple-500/10 text-[11px] font-bold text-purple-200 md:h-14 md:w-14 md:text-base">
                          M
                        </div>
                        <div className="min-w-0">
                          <div className="text-[11px] font-medium leading-tight text-white break-normal md:text-[17px]">
            ...
            <div className="mt-10 xl:hidden">
              <div className="mx-auto max-w-[760px] rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,24,43,0.98),rgba(9,14,24,0.99))] p-4 text-white shadow-[0_20px_70px_rgba(15,23,42,0.4)] sm:p-5">
                <div className="space-y-4">
                  {(content?.architecture?.processSteps ?? []).map(
                    (step: { icon: string; title: string; desc: string }, idx: number) => (
                      <React.Fragment key={step.title}>
                        <div className="w-full rounded-[22px] border border-white/10 bg-[#0f1829] px-4 py-4 shadow-[0_6px_18px_rgba(59,130,246,0.12)]">
                          <div className="flex items-center gap-3 min-w-0">
                            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[14px] border border-blue-300/20 bg-blue-500/10 text-[13px] font-bold text-blue-200">
                              {step.icon}
                            </div>
                            <div className="min-w-0">
                              <div className="text-[12px] font-bold leading-tight text-white break-normal">
                                {step.title}
                              </div>
                              <div className="mt-1 text-[10px] leading-4 text-gray-400 break-normal">
                                {step.desc}
                              </div>
                            </div>
                          </div>
                        ...
                        {idx < (content?.architecture?.processSteps?.length ?? 0) - 1 ? (
                          <div className="flex items-center justify-center text-[16px] leading-none text-blue-300">
                            ↓
                          </div>
                        ) : null}
                      </React.Fragment>
                  ...
                  <div className="rounded-[22px] border border-white/10 bg-[#0f1829] p-4 shadow-[0_6px_18px_rgba(59,130,246,0.12)]">
                    <div className="mx-auto w-fit rounded-full bg-gradient-to-r from-blue-500 to-purple-500 px-4 py-1.5 text-[10px] font-bold text-white">
                      Development
                    </div>

                    <div className="mt-3 space-y-3">
                      <div className="rounded-[18px] border border-blue-300/20 bg-[#101a2c] p-3">
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[12px] bg-blue-500/10 text-[10px] font-bold text-blue-200">
                            {content?.architecture?.layers?.top?.icon}
                          </div>
                          <div className="min-w-0">
                            <div className="text-[10px] font-semibold leading-tight text-blue-200/80 break-normal">
                              Frontend Development
                            </div>
                            <div className="mt-0.5 text-[9px] leading-4 text-blue-200/75 break-normal">
                              {content?.architecture?.layers?.top?.stack}
                            </div>
                            <div className="mt-1 text-[11px] font-bold leading-tight text-white break-normal">
                              {content?.architecture?.layers?.top?.title}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="rounded-[18px] border border-blue-300/20 bg-[#101a2c] p-3">
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="mt-0.5 text-[11px] font-bold leading-tight text-white break-normal">
                              Backend
                            </div>
                    ...
                    <div className="mt-2 flex items-center justify-center gap-2 text-[10px] leading-none text-blue-200/75">
                      <span>- -</span>
                      <span>Bug fixes & updates</span>
                      <span>- -</span>
                    </div>
                    <div className="mt-1 text-center text-[16px] leading-none text-blue-300">
                      ↓
                    </div>
                  </div>
                  ...
                  <div className="rounded-[22px] border border-white/10 bg-[#0f1829] p-4 shadow-[0_6px_18px_rgba(59,130,246,0.12)]">
                    ...
                    <div className="mt-3 rounded-[18px] border border-white/10 bg-[#101a2c] p-3">
                      <div className="text-[11px] font-semibold leading-tight text-white break-normal">
                        {content?.architecture?.layers?.services?.title}
                      </div>
                      <p className="mt-1 text-[9px] leading-4 text-gray-400 break-normal">
                  ...
                  <div className="rounded-[22px] border border-white/10 bg-[#0f1829] p-4 shadow-[0_6px_18px_rgba(59,130,246,0.12)]">
                    <div className="space-y-3">
                      ...
                      <div className="rounded-[18px] border border-blue-300/20 bg-[#101a2c] p-3">
                        <div className="flex items-start gap-3 min-w-0">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[12px] bg-purple-500/10 text-[10px] font-bold text-purple-200">
                            M
                          </div>
                          <div className="min-w-0">
                            <div className="text-[11px] font-semibold leading-tight text-white break-normal">
                            ...
                            <div className="mt-0.5 text-[10px] leading-4 text-blue-200/75 break-normal">
                              Feedback & sign-off
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="rounded-[22px] border border-white/10 bg-[#0f1829] p-4 shadow-[0_6px_18px_rgba(59,130,246,0.12)]">
                    <div className="space-y-3">
                      <div className="rounded-[18px] border border-blue-300/20 bg-[#101a2c] p-3">
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[14px] bg-blue-500/10 text-[10px] font-bold text-blue-200">
                            01
                          </div>
                          <div className="min-w-0">
                            <div className="text-[10px] font-medium leading-tight text-white break-normal">
                              Customer requirement
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="rounded-[18px] border border-blue-300/20 bg-[#101a2c] p-3">
                        <div className="flex items-center gap-3 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="text-[9px] leading-tight text-blue-200/75 break-normal">
                              server / cloud
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="rounded-[18px] border border-blue-300/20 bg-[#101a2c] p-3">
                        <div className="flex items-center gap-3 min-w-0">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[14px] bg-purple-500/10 text-[10px] font-bold text-purple-200">
                            M
                          </div>
                          <div className="min-w-0">
                            <div className="text-[10px] font-medium leading-tight text-white break-normal">
