...
const content: any = {
  ...
  architecture: {
    ...
    processSteps: [
      ...
      },
      {
        ...
        desc: "Integrate developers with your workflow and goals",
      },
    ],
    layers: {
      top: {
        icon: "</>",
        title: "Augmented Team Interface",
        stack: "Client Team / Delivery Layer",
        desc: "Direct collaboration between your internal team and augmented specialists.",
      },
      middle: [
        {
          icon: "[]",
      ...
      sideCards: [
        {
          ...
          desc: "Structured coordination for team efficiency and timely execution.",
        },
        {
          icon: "R",
          title: "Scalability",
          desc: "Increase or reduce team size based on project demand.",
        },
        {
          icon: "M",
  ...
  whyChoose: [
    {
      title: "Top Talent",
      desc:
        "Access a pool of highly experienced engineers with proven expertise across multiple technologies and industries, ready to contribute from day one.",
    },
    {
    ...
    },
    {
      ...
      desc:
        "Accelerate your development timelines without compromising quality by leveraging our ready-to-deploy skilled professionals.",
    },
  ],
  ...
  contactSubtitle:
    "Scale your team with our staff augmentation services. Tell us your requirements and we’ll connect you with the right talent to accelerate your project delivery.",
...
const ItCustomEnterpriseSoftwareItStaffAugmentation: React.FC = () => {
    ...
    <section className="relative min-h-screen bg-[#050816] text-white overflow-hidden">
      ...
      <div className="pt-28 pb-16 px-6 border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="rounded-[32px] overflow-hidden border border-white/10 bg-white/5 backdrop-blur-2xl shadow-[0_30px_100px_rgba(37,99,235,0.12)]">
            {/* Image Banner */}
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
          ...
          <div className="rounded-3xl bg-white/5 border border-white/10 p-10">
            <h2 className="text-3xl font-bold text-purple-300">Overview</h2>
            <p className="text-gray-300 mt-4 text-lg leading-relaxed">{content.overview}</p>
          </div>
          ...
          {/* Delivery */}
          <div className="rounded-3xl bg-white/5 border border-white/10 p-10">
            <h2 className="text-3xl font-bold text-blue-300">How We Deliver</h2>

            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {content.deliverySteps.map((step: any, i: number) => (
                <div
                  key={step.title}
                  className="group relative overflow-hidden p-7 rounded-[28px] bg-[#0b1220] border border-white/10 transition-all duration-300 hover:-translate-y-2 hover:border-blue-300/50 hover:shadow-[0_0_35px_rgba(59,130,246,0.18)]"
                >
                  ...
                  <div className="absolute top-0 left-6 right-6 h-px bg-gradient-to-r from-blue-400/40 via-purple-300/70 to-transparent" />
                  <div className="relative w-10 h-10 bg-purple-600 rounded-xl flex items-center justify-center font-bold">
                    {i + 1}
                  </div>
                  <h3 className="relative mt-4 font-bold text-white">{step.title}</h3>
                  <p className="relative text-gray-400 mt-2 leading-relaxed">{step.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Why Choose */}
          <div className="rounded-3xl bg-white/5 border border-white/10 p-10">
            <h2 className="text-3xl font-bold text-purple-300">Why Choose Us</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {content.whyChoose.map((item: any, idx: number) => (
                ...
                >
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.14),transparent_60%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-blue-300/60 to-transparent" />
                  <div className="relative text-sm font-semibold text-blue-300/80">0{idx + 1}</div>
                  <h3 className="relative mt-4 font-bold text-blue-200 group-hover:text-white transition-colors duration-300">
                    {item.title}
                  </h3>
                  <p className="relative text-gray-400 mt-2 leading-relaxed group-hover:text-gray-200 transition-colors duration-300">
                    {item.desc}
                  </p>
                </div>
              ))}
          ...
          <div id="contact" className="rounded-3xl bg-white/5 border border-white/10 p-10">
            <h2 className="text-3xl font-bold text-blue-300">{content.contactTitle}</h2>
...
export default ItCustomEnterpriseSoftwareItStaffAugmentation;
