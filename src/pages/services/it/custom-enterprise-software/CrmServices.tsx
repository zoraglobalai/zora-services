...
const heroImage = "/it-hero/crm.webp";
...
const content: any = {
    ...
    processSteps: [
      {
        ...
        desc: "Collect business goals & CRM expectations",
      },
      {
        icon: "02",
        title: "Requirement Analysis",
        desc: "Define workflows, users & solution scope",
      },
      {
        icon: "03",
        title: "Proposal / Planning",
        desc: "Shape CRM modules & process flow",
      },
      {
        icon: "04",
        title: "UI/UX Design",
        desc: "Align dashboards & user experience",
      },
    ],
    layers: {
      top: {
        ...
        desc: "User-facing interface for CRM dashboards and workflows.",
      },
      middle: [
        {
          icon: "[]",
        ...
        },
        {
          ...
          desc: "Secure access and identity management.",
        },
      ],
      services: {
        icon: "++",
      ...
      sideCards: [
        {
          ...
          desc: "Traffic distribution and faster response delivery.",
        },
        {
          icon: "R",
          title: "Cache (Redis)",
          desc: "Faster repeat requests and better performance.",
        },
        {
          icon: "M",
  ...
  contactSubtitle:
    "Looking to build or upgrade your CRM system? Share your requirements and our experts will help you design the perfect solution.",

  messageLabel: "Tell us about your CRM requirements...",
  submitLabel: "Request CRM Consultation",
};

const ItCustomEnterpriseSoftwareCrmServices: React.FC = () => {
          ...
          <div className="rounded-[32px] overflow-hidden border border-white/10 bg-white/5 shadow-[0_30px_100px_rgba(37,99,235,0.12)] backdrop-blur-2xl">
            ...
            <div className="relative px-8 py-16 md:px-14 md:py-20 text-center">
              ...
              <div className="mt-10 flex flex-wrap justify-center gap-4">
                <Link
                  to="/book-appointment"
                  className="px-8 py-4 bg-blue-600 rounded-2xl font-semibold hover:bg-blue-700 transition shadow-[0_0_40px_rgba(37,99,235,0.35)]"
                >
                  {content.primaryCta}
                </Link>
                <a
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
          <div className="bg-white/5 p-10 rounded-3xl border border-white/10">
            <h2 className="text-purple-300 text-2xl md:text-3xl font-bold">Overview</h2>
          ...
          {/* Delivery */}
          <div className="bg-white/5 p-10 rounded-3xl border border-white/10">
            <h2 className="text-blue-300 text-2xl md:text-3xl font-bold">How We Deliver</h2>
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 mt-6">
              {content.deliverySteps.map((s: any, i: number) => (
                <div
                  key={s.title}
                  className="group relative overflow-hidden p-6 bg-[#0b1220] rounded-[28px] border border-white/10 transition-all duration-300 hover:-translate-y-2 hover:border-blue-300/50 hover:shadow-[0_0_35px_rgba(59,130,246,0.18)]"
                >
                  ...
                  <div className="relative font-bold mb-2 w-10 h-10 rounded-xl bg-purple-600 flex items-center justify-center">
                    {i + 1}
                  </div>
                  <h3 className="relative font-semibold text-white">{s.title}</h3>
                  <p className="relative text-gray-400 mt-2 leading-relaxed">{s.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Why Choose Us */}
          <div className="bg-white/5 p-10 rounded-3xl border border-white/10">
            <h2 className="text-purple-300 text-2xl md:text-3xl font-bold">Why Choose Us</h2>
            <div className="grid md:grid-cols-3 gap-6 mt-6">
              {content.whyChoose.map((w: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative font-semibold mt-4 text-white">{w.title}</h3>
                  <p className="relative text-gray-400 mt-2 leading-relaxed">{w.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Contact */}
          <div id="contact" className="bg-white/5 p-10 rounded-3xl border border-white/10">
            <h2 className="text-blue-300 text-2xl md:text-3xl font-bold">{content.contactTitle}</h2>
            ...
            <form onSubmit={onSubmit} className="grid md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="md:col-span-2 flex gap-4 flex-wrap">
                <button className="px-6 py-3 bg-purple-600 rounded-xl hover:bg-purple-700 transition font-semibold">
                  {content.submitLabel}
                </button>
                <Link
                  to={"/services/it/" + category.slug}
                  className="px-6 py-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition font-semibold"
                >
...
export default ItCustomEnterpriseSoftwareCrmServices;
