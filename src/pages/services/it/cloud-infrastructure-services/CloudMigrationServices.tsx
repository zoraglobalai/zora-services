...
const content: any = {
  ...
  topBlocks: [
    ...
    },
    {
      ...
      desc: "Transform legacy on-premise infrastructure into highly scalable and flexible cloud environments using AWS, Microsoft Azure, or Google Cloud.",
    },
  ],
  ...
  contactSubtitle:
    "Planning to migrate to the cloud? Share your requirements and our experts will help you build a secure and efficient migration strategy.",

  messageLabel: "Tell us about your migration needs...",
  submitLabel: "Submit Inquiry",
};

const ItCloudInfrastructureServicesCloudMigrationServices: React.FC = () => {
...
export default ItCloudInfrastructureServicesCloudMigrationServices;
