...
const content: any = {
  ...
  technologies: [
    ...
    },
    {
      ...
      title: "Vulnerability Assessment & Penetration Testing",
      desc:
        "We use proven testing methodologies and security tools to identify exploitable weaknesses across systems and services.",
      items: ["Burp Suite", "Nmap", "Metasploit", "OpenVAS", "Nessus", "Manual Pen Testing"],
    },
    {
      icon: "database",
      ...
      sideCards: [
        {
          ...
          desc: "Improved understanding of system exposure and possible attack paths.",
        },
        {
          icon: "R",
          title: "Risk Prioritization",
          desc: "Classify vulnerabilities based on severity and business impact.",
        },
        {
          icon: "M",
  ...
  contactSubtitle:
    "Tell us about your security audit requirements and our cybersecurity experts will help you safeguard your business systems.",

  messageLabel: "Tell us about your security audit needs...",
  submitLabel: "Submit Project",
};

const ItCybersecuritySolutionsSecurityAudits: React.FC = () => {
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.deliverySteps ?? []).map((s: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative mt-5 font-bold text-gray-100">{s.title}</h3>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.whyChoose ?? []).map((w: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative mt-4 text-lg font-bold text-blue-200 group-hover:text-white transition-colors duration-300">
                    {w.title}
                  </h3>
...
export default ItCybersecuritySolutionsSecurityAudits;
