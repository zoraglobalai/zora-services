  ...
  "technologies": [
    {
      ...
      "desc": "We build responsive and interactive user interfaces using modern frontend frameworks.",
      "items": ["HTML", "CSS", "JavaScript", "React", "Angular", "Next.js"]
    },
    {
      "icon": "backend",
      "title": "Backend & API Technologies",
      "desc": "We develop secure and scalable backend systems and APIs for business applications.",
      "items": ["Python", "Spring Boot", "Nest.js", "Node.js", "Redis"]
    },
    {
      "icon": "database",
      "title": "Database & Storage",
      "desc": "We manage structured and scalable data using reliable database systems.",
    ...
    },
    {
      "icon": "mobile",
      "title": "Mobile Application Development",
      "desc": "We build cross-platform and native mobile applications with modern technologies.",
      "items": ["Flutter", "React Native", "Kotlin", "Swift"]
    },
    {
      "icon": "ai",
      "title": "AI Services & Solutions",
      "desc": "We integrate intelligent AI solutions to automate processes and enhance user experience.",
      "items": ["Machine Learning", "AI Chatbots", "NLP Solutions", "Computer Vision", "Generative AI", "AI Automation"]
    }
  ],
  "architecture": {
    ...
    <section className="relative min-h-screen bg-[#050816] text-white overflow-hidden">
      ...
      <div className="pt-28 pb-16 px-6 border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="rounded-[32px] overflow-hidden border border-white/10 bg-white/5 backdrop-blur-2xl">
            ...
            {/* Hero Content */}
            <div className="relative px-5 py-10 sm:px-8 sm:py-14 md:px-14 md:py-20 text-center">
              <h1 className="mx-auto max-w-3xl text-3xl sm:text-4xl md:text-6xl font-extrabold tracking-tight leading-[1.08]">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4">
                <Link
                  to="/book-appointment"
                  className="px-8 py-4 rounded-2xl font-semibold bg-blue-600 hover:bg-blue-700 transition shadow-[0_0_40px_rgba(37,99,235,0.35)] text-center"
                >
                ...
                <a
                  href="#contact"
                  className="px-8 py-4 rounded-2xl font-semibold bg-white/5 border border-white/10 hover:bg-white/10 transition text-center"
                >
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {(content?.topBlocks ?? []).map((b: { title: string; desc: string }) => (
              <div
                key={b.title}
                className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-7 transition-all duration-300 hover:-translate-y-2 hover:border-blue-300/50 hover:bg-[#0b1220] hover:shadow-[0_0_35px_rgba(59,130,246,0.18)]"
              >
                ...
                <h3 className="relative text-xl font-bold text-blue-300 transition-colors duration-300 group-hover:text-blue-200">
                  {b.title}
                </h3>
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
          ...
          {/* Overview */}
          <div className="rounded-3xl bg-white/5 border border-white/10 p-6 sm:p-10">
          ...
          {/* Project Duration */}
          <div className="rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(16,24,42,0.96),rgba(10,16,28,0.98))] p-6 sm:p-10">
            ...
            <div className="mt-10 grid md:grid-cols-2 xl:grid-cols-3 gap-6">
              {(content?.projectDuration?.cards ?? []).map(
                (card: { title: string; desc: string }) => (
                  <div
                    key={card.title}
                    className="group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-white/10 bg-[#0b1220] p-7 text-left transition-all duration-300 hover:-translate-y-2 hover:border-blue-300/50 hover:shadow-[0_0_35px_rgba(59,130,246,0.18)]"
                  >
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.16),transparent_58%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          ...
          <div className="rounded-3xl bg-white/5 border border-white/10 p-6 sm:p-10">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.deliverySteps ?? []).map((s: { title: string; desc: string }, idx: number) => (
                <div
                  key={s.title}
                  className="group relative overflow-hidden rounded-2xl border border-white/10 bg-[#0b1220] p-7 transition-all duration-300 hover:-translate-y-2 hover:border-purple-300/50 hover:shadow-[0_0_35px_rgba(139,92,246,0.16)]"
                >
                  ...
                  <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-purple-600 font-bold transition-transform duration-300 group-hover:scale-105">
                    {idx + 1}
                  </div>
                  <h3 className="relative mt-5 font-bold text-gray-100 transition-colors duration-300 group-hover:text-white">
                    {s.title}
                  </h3>
                  <p className="relative mt-2 leading-relaxed text-gray-400 transition-colors duration-300 group-hover:text-gray-200">
                    {s.desc}
                  </p>
                </div>
              ))}
          ...
          <div className="rounded-3xl bg-white/5 border border-white/10 p-10">
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight bg-gradient-to-r from-blue-300 via-blue-200 to-purple-300 bg-clip-text text-transparent">
          ...
          {/* Maintenance Support */}
          <div className="rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(18,20,39,0.96),rgba(10,16,28,0.98))] p-10">
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-blue-300">
          ...
          <div className="rounded-3xl bg-white/5 border border-white/10 p-10">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.whyChoose ?? []).map((w: { title: string; desc: string }) => (
                <div
                  key={w.title}
                  className="group relative overflow-hidden rounded-2xl border border-white/10 bg-[#0b1220] p-7 transition-all duration-300 hover:-translate-y-2 hover:border-blue-300/50 hover:shadow-[0_0_35px_rgba(59,130,246,0.18)]"
                >
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.14),transparent_60%)] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <h3 className="relative text-lg font-bold text-blue-200 transition-colors duration-300 group-hover:text-white">
                    {w.title}
                  </h3>
                  <p className="relative mt-2 leading-relaxed text-gray-400 transition-colors duration-300 group-hover:text-gray-200">
                    {w.desc}
          ...
          <div
            id="contact"
            className="rounded-3xl bg-white/5 border border-white/10 p-6 sm:p-10"
          >
            <h2 className="text-2xl md:text-3xl font-bold text-blue-300">
            ...
            <form onSubmit={onSubmit} className="mt-8 mx-auto max-w-3xl grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <input
                required
              ...
              <textarea
                ...
                className="w-full md:col-span-2 px-4 py-3 rounded-xl bg-[#0b1220] border border-white/10"
              />

              <div className="md:col-span-2 flex flex-col sm:flex-row gap-4">
                <button className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-purple-600 hover:bg-purple-700 transition font-semibold">
                ...
                <Link
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition font-semibold text-center"
                >
