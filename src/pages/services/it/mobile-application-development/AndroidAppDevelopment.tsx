...
const content: any = {
  ...
  "whyChoose": [
    ...
    },
    {
      ...
      "desc": "Our solutions are delivered with a business-oriented mindset, supported by a dedicated technical team with domain expertise. We act as a long-term technology partner focused on operational success and sustainable business growth."
    },
    {
...
const ItMobileApplicationDevelopmentAndroidAppDevelopment: React.FC = () => {
          ...
          <div className="rounded-3xl bg-white/5 border border-white/10 p-10">
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {(content?.whyChoose ?? []).map((w: { title: string; desc: string }) => (
                <div
                  key={w.title}
                  className="group relative overflow-hidden rounded-2xl border border-white/10 bg-[#0b1220] p-7 transition-all duration-300 hover:-translate-y-2 hover:border-blue-300/50 hover:shadow-[0_0_35px_rgba(59,130,246,0.18)] active:-translate-y-1 active:border-blue-300/60"
                >
...
export default ItMobileApplicationDevelopmentAndroidAppDevelopment;
