...
const heroImage = "/it-hero/rpa.webp";
...
const content: any = {
  ...
  topBlocks: [
    ...
    },
    {
      ...
      desc:
        "Combine rule-based workflows with AI decision-making to automate complex business processes and improve accuracy.",
    },
  ],
  ...
  contactTitle: "Automate Your Business Processes",
  contactSubtitle:
    "Looking to streamline operations with workflow automation or RPA? Share your requirements and our experts will connect with you.",
  messageLabel: "Tell us about your automation workflows, tools, or processes...",
  submitLabel: "Submit Project",
};

const ItAiAutomationSolutionsWorkflowAutomationRpa: React.FC = () => {
...
export default ItAiAutomationSolutionsWorkflowAutomationRpa;
