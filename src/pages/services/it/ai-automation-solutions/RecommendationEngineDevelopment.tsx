...
const heroImage = "/it-hero/recommendation.webp";
...
const content: any = {
  ...
  topBlocks: [
    ...
    },
    {
      ...
      desc:
        "Advanced segmentation and real-time personalization models to deliver dynamic user experiences across platforms.",
    },
  ],
  ...
  deliverySteps: [
    ...
    },
    {
      ...
      desc:
        "We integrate recommendation engines into your platform with real-time processing and continuously improve performance using analytics.",
    },
  ],
  ...
  contactTitle: "Build Your AI Recommendation System",
  contactSubtitle:
    "Looking to implement a recommendation engine? Share your requirements and our AI experts will connect with you.",
  messageLabel: "Tell us about your recommendation system requirements...",
  submitLabel: "Submit Project",
};

const ItAiAutomationSolutionsRecommendationEngineDevelopment: React.FC = () => {
              ...
              {(content?.whyChoose ?? []).map(
                (w: { title: string; desc: string }, idx: number) => (
                  ...
                  >
                    ...
                    <h3 className="relative text-lg font-bold text-blue-200 mt-4 transition-colors duration-300 group-hover:text-white">
                      {w.title}
                    </h3>
...
export default ItAiAutomationSolutionsRecommendationEngineDevelopment;
