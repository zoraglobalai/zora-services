...
const content: any = {
  heroTitle: "AI Computer Vision Solutions",
  heroSubtitle:
    "Transform images and videos into actionable insights using deep learning — from real-time detection to automated visual intelligence systems.",

  primaryCta: "Start Vision Project",
  ...
  topBlocks: [
    ...
    },
    {
      ...
      desc: "Automate defect detection and quality control in manufacturing and industrial workflows.",
    },
  ],
  ...
  deliverySteps: [
    ...
    },
    {
      ...
      desc: "Train high-performance deep learning models with optimized accuracy and efficiency.",
    },
    {
  ...
  contactTitle: "Build Your Computer Vision Solution",
  contactSubtitle:
    "Tell us your computer vision requirements and our AI experts will connect with you.",
  messageLabel: "Describe your computer vision project requirements...",
  submitLabel: "Submit Project",
};

const ItAiAutomationSolutionsComputerVisionSolutions: React.FC = () => {
    ...
    <section className="relative min-h-screen bg-[#050816] text-white overflow-hidden">
      ...
      <div className="pt-28 pb-16 px-6 border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-sm text-gray-400 mb-6">
            <Link to="/services" className="hover:text-purple-300 transition">Services</Link>
            <span className="mx-2">/</span>

            <Link to="/services/it" className="hover:text-purple-300 transition">IT Services</Link>
            <span className="mx-2">/</span>

            <Link to={`/services/it/${category.slug}`} className="hover:text-purple-300 transition">
              {category.title}
            </Link>
            <span className="mx-2">/</span>
          ...
          <div className="rounded-[32px] overflow-hidden border border-white/10 bg-white/5 shadow-[0_30px_100px_rgba(37,99,235,0.12)] backdrop-blur-2xl">
            ...
            {/* Content */}
            <div className="px-8 py-16 md:px-14 md:py-20 text-center">
      ...
      <div className="px-6 py-16">
        <div className="max-w-6xl mx-auto space-y-14">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {content.deliverySteps.map((s: any, i: number) => (
                ...
                >
                  ...
                  <h3 className="relative mt-4 font-bold text-gray-100 transition-colors duration-300 group-hover:text-white group-active:text-white">
                    {s.title}
                  </h3>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-8">
              {content.whyChoose.map((w: any, idx: number) => (
                ...
                >
                  ...
                  <h3 className="relative font-bold text-blue-200 mt-4 transition-colors duration-300 group-hover:text-white">
                    {w.title}
                  </h3>
          ...
          {/* Contact */}
          <div id="contact" className="p-10 bg-white/5 rounded-3xl border border-white/10">
            ...
            <form onSubmit={onSubmit} className="grid md:grid-cols-2 gap-6 mt-8">
              <input
                ...
                className="p-3 rounded-xl bg-[#0b1220] border border-white/10"
              />
              ...
              <textarea
                ...
                className="md:col-span-2 p-3 rounded-xl bg-[#0b1220] border border-white/10"
              />

              <div className="md:col-span-2 flex gap-4 flex-wrap">
                <button className="px-8 py-4 bg-purple-600 rounded-2xl font-semibold hover:bg-purple-700 transition">
                  {content.submitLabel}
                </button>
...
export default ItAiAutomationSolutionsComputerVisionSolutions;
