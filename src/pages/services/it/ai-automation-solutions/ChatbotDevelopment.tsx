...
const content: any = {
  ...
  deliverySteps: [
    ...
    },
    {
      ...
      desc: "We deploy chatbots across platforms and continuously optimize performance using analytics and user behavior.",
    },
  ],
  ...
  contactTitle: "Start Your AI Chatbot Project",
  contactSubtitle:
    "Looking to automate your business with AI chatbots? Share your requirements and our experts will help you build the right solution.",
  messageLabel: "Tell us about your chatbot requirements...",
  submitLabel: "Submit Project",
};

const ItAiAutomationSolutionsChatbotDevelopment: React.FC = () => {
...
export default ItAiAutomationSolutionsChatbotDevelopment;
