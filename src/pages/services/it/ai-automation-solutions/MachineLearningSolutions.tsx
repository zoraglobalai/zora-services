...
const content: any = {
  ...
  topBlocks: [
    {
      title: "AI Automation",
      desc:
        "Automate repetitive workflows and decisions using machine learning and intelligent algorithms.",
    },
    {
    ...
    },
    {
      ...
      desc:
        "Deliver dynamic personalization across platforms using behavioral and ML models.",
    },
  ],
  ...
  contactTitle: "Build Your AI Solution",
  contactSubtitle:
    "Share your machine learning requirements and our experts will connect with you.",
  messageLabel: "Describe your AI / ML project requirements...",
  submitLabel: "Submit Project",
};

const ItAiAutomationSolutionsMachineLearningSolutions: React.FC = () => {
...
export default ItAiAutomationSolutionsMachineLearningSolutions;
